                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tambah Postingan Tanah</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card card-primary">
                                    ...
                                    <input type="hidden" name="kd_pengguna" value="<?= $kd_pengguna1; ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Gambar Properti Tanah</label>
